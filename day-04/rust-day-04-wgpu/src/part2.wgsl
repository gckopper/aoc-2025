...
fn main(
    ...
    output[global_invocation_id.x + global_invocation_id.y * num_workgroups.x] = input[global_invocation_id.x + global_invocation_id.y * num_workgroups.x] -  64 * u32(v_1_1 == 64 && (v_0_0 + v_0_1 + v_0_2 + v_1_0 + v_1_2 + v_2_0 + v_2_1 + v_2_2) < 4);
}
